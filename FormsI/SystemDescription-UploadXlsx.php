...
<title>Upload xlsx to SystemDescription</title></head>
<body>
<?php
...
echo("<hr><h4> Upload Xlsx file for ".GetStr($pdo, 'SystemDescription')."</h4>");

$FldsIndxArr= array ( 'Id'=>-1,  'ParagraphNo'=>-1,  'ElType'=>-1,  'Description'=>-1, 
           'Ord1'=>-1,  'ParentId'=>-1);

$ColHeader= array ( 'Id'=>'Id',  'ParagraphNo'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=ParagraphNo\' target=Translate>_</a>ParagraphNo',  'ElType'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=ElType\' target=Translate>_</a>ElType',  'Description'=>'Описание', 
           'Ord1'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=Ord1\' target=Translate>_</a>Ord1',  'ParentId'=>'Id родителя');
