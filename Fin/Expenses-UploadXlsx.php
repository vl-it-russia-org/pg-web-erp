...
<title>Upload xlsx to Expenses</title></head>
<body>
<?php
...
echo("<hr><h4> Upload Xlsx file for ".GetStr($pdo, 'Expenses')."</h4>");

$FldsIndxArr= array ( 'ExpId'=>-1,  'ExpenseName'=>-1,  'HaveRegions'=>-1,  'FinDiv'=>-1);

$ColHeader= array ( 'ExpId'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=ExpId\' target=Translate>_</a>ExpId',  'ExpenseName'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=ExpenseName\' target=Translate>_</a>ExpenseName',  'HaveRegions'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=HaveRegions\' target=Translate>_</a>HaveRegions',  'FinDiv'=>'<a href=\'https://kolya.it-russia.org/PG2025/FormsI/TranslateFrm.php?Enum=FinDiv\' target=Translate>_</a>FinDiv');
...
$EnumArr=array('FinDiv'=>'ExpensesDiv');
$DateArr=array();
...
if ($FldsIndxArr['ExpId']==-1) {
  die ("<br> Error: field ExpId: {$ColHeader['ExpId']} is not found ");
}
